        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (cursor.moveToFirst()) {
                ...
                if (status == DownloadManager.STATUS_SUCCESSFUL) {
                    Toast.makeText(LibraryActivity.this, "다운로드 성공", Toast.LENGTH_SHORT).show();
                }
            }
        }
    };
    private Handler handler = new Handler(Looper.myLooper()) {
        ...
        public void handleMessage(@NonNull Message msg) {
            if (msg.arg1 == 1) {
                ...
                libraryRVAdapter.setOnItemLongClickListener(new LibraryRVAdapter.OnItemLongClickListerner() {
                    @Override
    ...
    public void getLibraryList() {
        try {
            ...
            RequestBody formBody = new FormBody.Builder()
                    .add("get_uid", User.currentUser.getPairId())
                    .build();
                ...
                if (body != null) {
                    ...
                    if (data.equals("None")) {
                        handler.post(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(LibraryActivity.this, "자료가 없습니다.", Toast.LENGTH_SHORT).show();
                            }
                        });
                    } else {
